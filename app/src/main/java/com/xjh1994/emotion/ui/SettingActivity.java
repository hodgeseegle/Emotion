...
import com.xjh1994.emotion.util.AppManager;
...
public class SettingActivity extends BaseActivity {
    ...
    public static class SettingsFragment extends PreferenceFragment {
        ...
        public void share() {
            ...
            intent.putExtra(Intent.EXTRA_TEXT, getString(R.string.share_app_text));   //附带的说明信息
            intent.setType("text/plain");
            startActivity(Intent.createChooser(intent, new StringBuilder().append(getString(R.string.share_title)).append(getString(R.string.app_name)).toString()));
        }
    }
}
